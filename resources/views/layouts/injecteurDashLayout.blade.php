        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                ...
                <div class="top-left-part">
                    <!-- Logo -->
                    <a class="logo p-l-5" href="{{ url('ajouter-client') }}">
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    <li>
                        <a href="{{ url('ajouter-client') }}" class="waves-effect"><i data-icon="7" class=" icon-user-follow" style="font-size: 20px;"> </i> <span class="hide-menu" style="font-size: 18px;"> Ajouter Client </span></a> 
                    </li>
                    <li>
                        <a href="{{ url('all-Clients') }}" class="waves-effect"><i data-icon="7" class="fa fa-users" style="font-size: 20px; margin-right: 4px;"> </i> <span class="hide-menu" style="font-size: 18px;"> List des Clients</span></a> 
                    </li>
                    <li><a href="{{ url('deleted-Clients') }}" class="waves-effect"><i data-icon="7" class=" icon-user-unfollow" style="font-size: 20px; margin-right: 4px;"> </i> <span class="hide-menu" style="font-size: 18px;"> Clients Supprimés</span></a> </li>
