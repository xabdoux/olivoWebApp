        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li><a href="{{ url('finishedClients', 14) }}" class="waves-effect"><i data-icon="7" class="fa fa-sign-out" style="font-size: 20px; margin-right: 4px;"> </i> <span class="hide-menu" style="font-size: 18px;"> Archives</span></a> </li>
                    ...
                    <li><a href="{{ url('compta-historique') }}" class="waves-effect"><i data-icon="7" class="fa fa-history" style="font-size: 20px; margin-right: 4px;"> </i> <span class="hide-menu" style="font-size: 18px;"> Historique Comptabilité</span></a> </li>
