     ...
     <div class="lg-info-panel">
              <div class="inner-panel">
                  ...
                  <div class="lg-content">
                      <h2>ASSOCIATION OF SCIENTIFIC RESEARCH, INNOVATION AND TECHNOLOGY.</h2>
                      
                      <br><br><br><br><br><br><br><br>
                    <p>Copyright © 2018 ASRIT - All Rights Reserved</p>
                  </div>
              </div>
      </div>
    </div>
        <div class="new-login-box m-t-15">
            <div class="white-box ">
                <a href="javascript:void(0)" class="text-center db"><img src="{{ asset('ample/plugins/images/admin-logo-dark.png')}}" width="100px" height="100px" alt="Home" /><br/><h3>OLIVO AL'CAZAR</h3></b></a>  
                    ...
                    <div class="form-group m-b-15">
                        <div class="col-xs-12">
                            <input class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" id="name" type="text"  
                                  required name="name" value="{{ old('name') }}" autofocus placeholder="Name">
                            @if ($errors->has('name'))
