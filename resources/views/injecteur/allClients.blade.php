          ...
          @foreach ($clients as $client)
            <tr >
                ...
                <td>
                  <div class="row">
                    <div class="col-xs-6">
                     <a href="{{ url('ShowClientDetails', $client->id) }}"> <i class="fa fa-info-circle" style="font-size: 30px;color: #0082BA"></i></a>
                    </div>
                    <div class="col-xs-6">
                    ...
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="mySmallModalLabel"><div data-icon="G" class="linea-icon linea-basic text-center text-danger"> êtes-vous sûr de vouloir supprimer !<div></h4>
                            </div>
                            <div class="modal-body"> 
                                ...
                                <a href="{{ url('deleteClient/'.$client->id) }}" class="btn btn-info waves-effect waves-light ">
                                    <span>Oui, Supprimer</span> <i class="fa fa-check"></i>
                                </a>
...
<script src="{{ asset('ample/plugins/bower_components/sweetalert/jquery.sweet-alert.custom.js') }}"></script>
    ...
    <script>
        swal('Success!', "{{session()->get('deleteClient')}}", 'success');
    </script>
@endif 
@endsection