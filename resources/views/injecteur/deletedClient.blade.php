          ...
          @foreach ($trashedClients as $client)
            <tr >
                ...
                <td>
                  <div class="row">
                    <div class="col-xs-6">
                     <a href="{{ url('ShowTrashedClientDetails', $client->id) }}"> <i class="fa fa-info-circle" style="font-size: 30px;color: #0082BA"></i></a>
                    </div>
                    <div class="col-xs-6">
                      {{-- <i class="fa fa-trash-o" style="font-size: 30px; color: red"></i> --}}
                      <a href="#" data-toggle="modal" data-target=".{{$client->id}}" id="{{$client->id}}">
                                    <i class="fa fa-share-square-o" style="font-size: 30px; color: red"></i>
                                </a>
                    </div>
                  </div>
                </td>
